...
import com.turqmelon.Populace.GUI.TownManagement.TownBoardGUI;
        ...
        if ((sender instanceof Player)) {
            ...
            if (resident != null) {
                ...
                if (resident.getTown() != null) {
                    ...
                    if (resident.getTown().getLevel().getResidents() >= TownLevel.VILLAGE.getResidents()) {
                        TownBoardGUI gui = new TownBoardGUI(resident, resident.getTown());
                        gui.open(player);
                    } else {
                        player.sendMessage(Msg.ERR + resident.getTown().getName() + " hasn't unlocked the message board yet.");
                        player.sendMessage(Msg.ERR + "This feature will unlock once your town reaches \"Village\" level.");
                    }
